			...
			<div id="item-body">
				...
				if ( bp_group_is_visible() ) :
					...
					// Not looking at home
						...
						// CLAN POSTS
						elseif ( bp_is_group_activity()   ) : locate_template( array( 'groups/single/anth-blog.php'     ), true );
						...
						// NEW BLOG STREAM
						elseif ( bp_is_group_forum()      ) : locate_template( array( 'groups/single/anth-blog.php'        ), true );
