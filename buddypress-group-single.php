                       ...
                       <div id="item-nav"> <!-- movwed inside #primary-->
                            <div class="item-list-tabs no-ajax" id="object-nav" role="navigation">
                                    <ul>
                                        ...
                                        <li id="nav-blog-groups-li">
                                            <a id="nav-blogs" href="http://192.168.33.10/wordpress/anth/groups/test-group/anth-posts/">Group Posts</a>
                                        </li>
                        ...
                        <div id="item-body">
                                ...
                                // Not looking at home
                                    ...
                                    // Maybe Blogs    
                                    elseif ( bp_is_group_forum()      ) : bp_get_template_part( 'groups/single/anth-blog'        );
